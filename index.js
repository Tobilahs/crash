/*
 ...
 # 
 - GW AKAN MERILIS SC FATAL V5 NEW SUPPORT BUG UI NEW OKEH JADI JANGAN LUPA SUPPORT THX FOR PUTRA ZACK
*/
...
const { version, isLatest } = await fetchLatestBaileysVersion()
    console.log(chalk.red.bold('THE KING HEXAGON CRASH @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\nPutra Version 12.0.0\n\nCreated By : Putra Developer\nTelegram : @UserAmpas\nSubscribe Youtube : @Putrayy'))
...
zyn.sendMessage(`6283123402262@s.whatsapp.net`, { text: `\`𝗛𝗶 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿\`
  UDH KONEK PUT GANTENG `})
if (autoJoin) {
